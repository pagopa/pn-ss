...
public class FileMetadataUpdateApiController implements FileMetadataUpdateApi {
    ...
    public Mono<ResponseEntity<OperationResultCodeResponse>> updateFileMetadata
        ...
        return updateFileMetadataRequest.flatMap(request -> service.createUriForUploadFile(
        																fileKey,xPagopaSafestorageCxId, request,
        																pagopaSafestorageCxIdValue, apiKeyValue))
