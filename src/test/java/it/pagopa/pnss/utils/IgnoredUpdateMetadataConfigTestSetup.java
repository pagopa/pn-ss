...
public class IgnoredUpdateMetadataConfigTestSetup {
    ...
    @BeforeAll
    public static void beforeAll(@Autowired S3Client s3TestClient, @Autowired BucketName bucketName, @Autowired IgnoredUpdateMetadataConfig ignoredUpdateMetadataConfig) throws IOException {
        byte[] fileBytes;
