...
public interface ArubaSignService {
    ...
    @RequestWrapper(localName = "getVersion", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.GetVersion")
    @ResponseWrapper(localName = "getVersionResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.GetVersionResponse")
     ...
     * @param apparence
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.SignReturnV2
     * @throws TypeOfTransportNotImplemented_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "pdfsignatureV2", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.PdfsignatureV2")
    @ResponseWrapper(localName = "pdfsignatureV2Response", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.PdfsignatureV2Response")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "xmlsignature", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Xmlsignature")
    @ResponseWrapper(localName = "xmlsignatureResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.XmlsignatureResponse")
     ...
     * @param identity
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.UserCertList
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "listCert", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.ListCert")
    @ResponseWrapper(localName = "listCertResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.ListCertResponse")
     ...
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.SignHashReturn
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "signhash", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Signhash")
    @ResponseWrapper(localName = "signhashResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.SignhashResponse")
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "pkcs7signV2", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Pkcs7SignV2")
    @ResponseWrapper(localName = "pkcs7signV2Response", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Pkcs7SignV2Response")
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "addpkcs7sign", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Addpkcs7Sign")
    @ResponseWrapper(localName = "addpkcs7signResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Addpkcs7SignResponse")
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "pkcs7signhash", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Pkcs7Signhash")
    @ResponseWrapper(localName = "pkcs7signhashResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Pkcs7SignhashResponse")
     ...
     * @param markRequest
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.MarkReturn
     * @throws TypeOfTransportNotImplemented_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "tsd", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Tsd")
    @ResponseWrapper(localName = "tsdResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.TsdResponse")
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "m7m", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.M7M")
    @ResponseWrapper(localName = "m7mResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.M7MResponse")
     ...
     * @param signRequest
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.SignReturn
     * @throws TypeOfTransportNotImplemented_Exception
     */
    @WebMethod(operationName = "pkcs7sign")
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "pkcs7sign", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Pkcs7Sign")
    @ResponseWrapper(localName = "pkcs7signResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Pkcs7SignResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "pdfsignature", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Pdfsignature")
    @ResponseWrapper(localName = "pdfsignatureResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.PdfsignatureResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "listprocess", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Listprocess")
    @ResponseWrapper(localName = "listprocessResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.ListprocessResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "opensession", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Opensession")
    @ResponseWrapper(localName = "opensessionResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.OpensessionResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "closesession", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Closesession")
    @ResponseWrapper(localName = "closesessionResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.ClosesessionResponse")
     ...
     * @param username
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.UserCertListAuth
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "listCertAuth", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.ListCertAuth")
    @ResponseWrapper(localName = "listCertAuthResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.ListCertAuthResponse")
     ...
     * @param identity
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.ArssReturn
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "verifyOtp", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.VerifyOtp")
    @ResponseWrapper(localName = "verifyOtpResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.VerifyOtpResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "sendCredential", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.SendCredential")
    @ResponseWrapper(localName = "sendCredentialResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.SendCredentialResponse")
     ...
     * @param type
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.RetriveCredentialReturn
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "retriveCredential", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.RetriveCredential")
    @ResponseWrapper(localName = "retriveCredentialResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.RetriveCredentialResponse")
     ...
     * @param identity
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.EncryptedEnvelopReturn
     * @throws TypeOfTransportNotImplemented_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "encryptedEnvelope", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.EncryptedEnvelope")
    @ResponseWrapper(localName = "encryptedEnvelopeResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.EncryptedEnvelopeResponse")
     ...
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.GwReturn
     */
    @WebMethod(operationName = "test_otp")
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "test_otp", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.TestOtp")
    @ResponseWrapper(localName = "test_otpResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.TestOtpResponse")
     ...
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.CredentialListReturn
     */
    @WebMethod(operationName = "credentials_query")
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "credentials_query", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.CredentialsQuery")
    @ResponseWrapper(localName = "credentials_queryResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.CredentialsQueryResponse")
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "change_password", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.ChangePassword")
    @ResponseWrapper(localName = "change_passwordResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.ChangePasswordResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "sendCredentialAuth", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.SendCredentialAuth")
    @ResponseWrapper(localName = "sendCredentialAuthResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.SendCredentialAuthResponse")
     ...
     * @param signRequestV2
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.SignReturnV2Multiple
     * @throws TypeOfTransportNotImplemented_Exception
     */
    @WebMethod(operationName = "pkcs7signV2_multiple")
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "pkcs7signV2_multiple", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Pkcs7SignV2Multiple")
    @ResponseWrapper(localName = "pkcs7signV2_multipleResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Pkcs7SignV2MultipleResponse")
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "pkcs7signhash_multiple", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Pkcs7SignhashMultiple")
    @ResponseWrapper(localName = "pkcs7signhash_multipleResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Pkcs7SignhashMultipleResponse")
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "pdfsignatureV2_multiple", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.PdfsignatureV2Multiple")
    @ResponseWrapper(localName = "pdfsignatureV2_multipleResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.PdfsignatureV2MultipleResponse")
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "xmlsignature_multiple", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.XmlsignatureMultiple")
    @ResponseWrapper(localName = "xmlsignature_multipleResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.XmlsignatureMultipleResponse")
     ...
     * @param identity
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.AuthMethodsReturn
     */
    @WebMethod(operationName = "auth_methods")
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "auth_methods", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.AuthMethods")
    @ResponseWrapper(localName = "auth_methodsResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.AuthMethodsResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "pdfsignatureDTS", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.PdfsignatureDTS")
    @ResponseWrapper(localName = "pdfsignatureDTSResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.PdfsignatureDTSResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "updateSignature", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.UpdateSignature")
    @ResponseWrapper(localName = "updateSignatureResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.UpdateSignatureResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "jwsSignature", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.JwsSignature")
    @ResponseWrapper(localName = "jwsSignatureResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.JwsSignatureResponse")
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "jwsSignature_multiple", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.JwsSignatureMultiple")
    @ResponseWrapper(localName = "jwsSignature_multipleResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.JwsSignatureMultipleResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "tsr", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Tsr")
    @ResponseWrapper(localName = "tsrResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.TsrResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "ping", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Ping")
    @ResponseWrapper(localName = "pingResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.PingResponse")
     ...
     * @param request
     * @return
     *     returns it.pagopa.pnss.transformation.wsdl.VerifyReturn
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "verify", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.Verify")
    @ResponseWrapper(localName = "verifyResponse", targetNamespace = "http://arubasignservice.arubapec.it/", className = "it.pagopa.pnss.transformation.wsdl.VerifyResponse")
