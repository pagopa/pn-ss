...
//    public static final String X_PAGOPA_SAFESTORAGE_CX_ID = "x-pagopa-safestorage-cx-id";
    ...
    private WebTestClient.ResponseSpec fileMetadataUpdateTestCall(BodyInserter<UpdateFileMetadataRequest, ReactiveHttpOutputMessage> bodyInserter,
                                                          String docuemntKey ) {
    ...
    void testDocumentKeyNotPresent() throws Exception {
        ...
        WebTestClient.ResponseSpec responseSpec = fileMetadataUpdateTestCall(BodyInserters.fromValue(req), X_PAGOPA_SAFESTORAGE_CX_ID).expectStatus().isNotFound();
    ...
    void testErrorStatus() throws Exception {
        ...
        fileMetadataUpdateTestCall(BodyInserters.fromValue(req), X_PAGOPA_SAFESTORAGE_CX_ID).expectStatus().isNotFound();
    ...
    void testErrorUserCongigurationWithoutPrivileg() throws Exception {
        ...
        WebTestClient.ResponseSpec responseSpec = fileMetadataUpdateTestCall(BodyInserters.fromValue(req), X_PAGOPA_SAFESTORAGE_CX_ID).expectStatus().isForbidden();
    ...
    void testFileMetadataUpgateOk() throws Exception {
        ...
        WebTestClient.ResponseSpec responseSpec = fileMetadataUpdateTestCall(BodyInserters.fromValue(req), X_PAGOPA_SAFESTORAGE_CX_ID).expectStatus().isOk();
