...
public class MockPecUtils {
    ...
    public static void mockAltProvPdfSignatureV2Async(AlternativeSignProviderService alternativeSignProviderService, String returnStatus, byte[] returnFileBytes, String resultType) {
        when(alternativeSignProviderService.signPdfDocument(any(), any())).thenAnswer(invocation -> {
            switch (resultType) {
                case RESP_OK:
                    AsyncHandler handler = invocation.getArgument(1, AsyncHandler.class);
                    Response<PdfsignatureV2Response> response = mock(Response.class);
    ...
    public static void mockAltProvXmlSignatureAsync(AlternativeSignProviderService alternativeSignProviderService, String returnStatus, byte[] returnFileBytes, String resultType) {
        when(alternativeSignProviderService.signXmlDocument(any(), any())).thenAnswer(invocation -> {
            switch (resultType) {
                case RESP_OK:
                    AsyncHandler<XmlsignatureResponse> handler = invocation.getArgument(1, AsyncHandler.class);
                    Response<XmlsignatureResponse> response = mock(Response.class);
    ...
    public static void mockAltProvPkcs7SignV2Async(AlternativeSignProviderService alternativeSignProviderService, String returnStatus, byte[] returnFileBytes, String resultType) {
        when(alternativeSignProviderService.pkcs7Signature(any(), any())).thenAnswer(invocation -> {
            switch (resultType) {
                case RESP_OK:
                    AsyncHandler<Pkcs7SignV2Response> handler = invocation.getArgument(1, AsyncHandler.class);
                    Response<Pkcs7SignV2Response> response = mock(Response.class);
